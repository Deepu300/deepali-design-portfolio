      ...
      <div className={styles.shell}>
        ...
        <main className={styles.shellContent}>
          ...
          <header className={styles.hero} id="hero">
            ...
            <p className={cx(styles.heroIntro, styles.reveal, styles.d3)}>
            ...
            <dl className={cx(styles.heroMeta, styles.reveal, styles.d4)}>
              <div>
                <dt>My Role</dt>
                <dd>UX Research &amp; Design</dd>
              </div>
              <div>
                <dt>Timeline</dt>
                <dd>End-to-end concept</dd>
              </div>
              <div>
                <dt>Platform</dt>
                <dd>iOS · Walking Nav</dd>
              </div>
              <div>
                <dt>Scope</dt>
                <dd>Research → Hi-Fi Prototype</dd>
              </div>
            </dl>
          </header>
          ...
          <section id="problem" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>The problem</p>
          ...
          <section id="process" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>Problem statement</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
            ...
            <p className={cx(styles.label, styles.reveal, styles.processEy)}>
              The process
            </p>
          ...
          <section id="research" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>Quantitative data</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
          ...
          <section className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>
            ...
            <p className={cx(styles.lead, styles.reveal)} style={{ marginTop: 28 }}>
          ...
          {/* SURVEY FINDINGS */}
          <section className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>What users told us</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
              Four findings.
            </h2>
          ...
          {/* KEY INSIGHTS */}
          <section id="insight" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>Key Insights</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
          ...
          {/* HMW */}
          <section className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>How might we</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
          ...
          <section id="ideation" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>Ideation</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
              We bet on audio.
            </h2>
            <p className={cx(styles.lead, styles.reveal, styles.d2)}>
          ...
          {/* USER FLOW */}
          <section className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>User flow</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
          ...
          <section id="solution" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>The solution</p>
            <h2 className={cx(styles.claim, styles.reveal, styles.d1)}>
          ...
          {/* USABILITY */}
          <section id="testing" className={styles.block}>
            <p className={cx(styles.label, styles.reveal)}>Usability feedback</p>
          ...
          {/* REFLECTION */}
          <section id="reflection" className={styles.band}>
            <p className={cx(styles.label, styles.reveal)}>Reflection</p>
