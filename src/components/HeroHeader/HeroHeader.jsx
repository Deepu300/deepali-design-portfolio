      ...
      <div className="relative flex flex-col items-center justify-center w-full h-[70%] lg:min-h-[50vh] gap-12 md:gap-16 my-12 md:my-20 hero-header__wrapper">
        ...
        <div className="text-center">
          ...
          <h3 className="text-base md:text-2xl lg:mt-20 line-height-large-between">
            ...
            <br />
            Previously{" "}
            <Link href={"https://www.adobe.com/in/"} target="_blank">
              @Adobe
            </Link>{" "}
            <Link href={"https://www.bosch.com/"} target="_blank">
              @Bosch
            </Link>{" "}
            <Link href={"https://www.hdfcbank.com/"} target="_blank">
              @HDFC
            </Link>
          </h3>
        </div>
        ...
        <div className="absolute top-0 left-0 z-0 w-full h-full">
          ...
          >
            ...
            <m.svg
              ...
              className="absolute w-32 top-3 left-0 md:w-48 lg:left-0 animate-float"
              // ADDED: Apply the variants
              variants={svgItemVariants}
            >
              <path
                d="M200.955 1.01159C224.566 -1.14198 245.452 16.2521 247.605 39.8623C249.759 63.4726 232.365 84.3584 208.754 86.5121L-12.4571 106.69L-20.2561 21.1896L200.955 1.01159Z"
                fill="#BCCBEA"
                stroke="#363636"
                strokeWidth="1.6623"
              />
            ...
            >
              <path
                d="M110.853 36.4399L111.101 36.7118L111.426 36.5392L154.702 13.4439L151.511 61.1354L151.485 61.5183L151.854 61.622L198.818 74.8578L161.941 106.81L161.651 107.061L161.837 107.397L185.007 149.203L136.017 146.705L135.649 146.686L135.541 147.037L121.327 192.951L88.9387 157.44L88.6909 157.168L88.3664 157.341L45.0887 180.436L48.2814 132.745L48.307 132.362L47.9374 132.258L0.97343 119.021L37.8505 87.0701L38.1407 86.8192L37.9547 86.4835L14.7843 44.6766L63.775 47.1758L64.1423 47.1939L64.251 46.8425L78.4638 0.929375L110.853 36.4399Z"
                fill="#E3C9EB"
                stroke="#363636"
      ...
      <div className="w-full py-3 overflow-hidden md:py-9 hero-infinite-scroll bg-[#363636] text-gray-200">
        ...
        >
          {infinite_scroll.map((item, idx) => (
            <li
              key={`${idx}`}
              className="flex items-center gap-4 md:gap-12 whitespace-nowrap"
            >
              {item}
              <svg
                width="22"
